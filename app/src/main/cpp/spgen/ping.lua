...
synth.env = SP:tenvx("env", 0.001, 0.002, 0.01)
...
synth.trand = SP:trand("tr", 100, 10000)
synth.delay = SP:delay("delay", 0.9, 1.1)
synth.butlp = SP:butlp("lpf", 1000)
synth.modal = SP:modal("mode")

synth.voice1 = SP:fosc("voice1", synth.sine, 440, 0.01, 1, 1, 1)
synth.voice2 = SP:fosc("voice2", synth.sine, 440, 0.01, 1, 1, 1)
